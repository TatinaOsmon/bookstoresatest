...
import 'book_checkout_widget.dart' show BookCheckoutWidget;
import 'package:flutter/material.dart';

class BookCheckoutModel extends FlutterFlowModel<BookCheckoutWidget> {
  ...
  // Stores action output result for [Backend Call - API (bookCart findAll)] action in bookCheckout widget.
  ApiCallResponse? initial;
  // Stores action output result for [Backend Call - API (bookCart createOrder)] action in Button widget.
