...
import 'tool_checkout_widget.dart' show ToolCheckoutWidget;
import 'package:flutter/material.dart';

class ToolCheckoutModel extends FlutterFlowModel<ToolCheckoutWidget> {
  ...
  // Stores action output result for [Backend Call - API (toolCart findAll)] action in toolCheckout widget.
  ApiCallResponse? initial;
  // Stores action output result for [Backend Call - API (toolCart createOrder)] action in Button widget.
